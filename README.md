...
[![](http://cranlogs.r-pkg.org/badges/GetTDData)](https://CRAN.R-project.org/package=GetTDData)
...
See [vignette for more examples](https://CRAN.R-project.org/package=GetTDData).
